...
public class Example2ParserTest {
	...
	public void Example2ParserTestTest() throws Exception {
		...
		System.out.println("Tokens to parse:");
		...
		// Add after parsing
		System.out.println("\n=== Parsing Results ===");
		System.out.println("Classes found: " + tran.Classes.size());
		tran.Classes.forEach(c -> {
			System.out.println("Class: " + c.name);
			System.out.println("  Members: " + c.members.size());
			System.out.println("  Constructors: " + c.constructors.size());
			System.out.println("  Methods: " + c.methods.size());
		});
		System.out.println("Interfaces found: " + tran.Interfaces.size());
